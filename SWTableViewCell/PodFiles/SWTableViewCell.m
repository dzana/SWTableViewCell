...
- (void)initializer
{
    ...
    for (NSUInteger i = 0; i < 2; ++i)
    {
        ...
        [self addConstraints:@[
                               ...
                               [NSLayoutConstraint constraintWithItem:buttonView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationLessThanOrEqual toItem:self.contentView attribute:NSLayoutAttributeWidth multiplier:1.0 constant:-self.frame.size.height],
                               ]];
    }
}
